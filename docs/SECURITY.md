...
> For detailed technical documentation on our Zero-Trust AI Invariant, 10-layer safety matrix, and cryptographic action contracts, please refer to [SECURITY_ARCHITECTURE.md](SECURITY_ARCHITECTURE.md) or the Security section in [README.md](../README.md).