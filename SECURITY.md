...
If you discover a security vulnerability within ReviveOS:
1. Please notify the security team at **`security@reviveos.ai`** or submit a private security advisory on GitHub.
2. **Response SLA**: All security reports are acknowledged within **24 hours**.
3. We operate under **Coordinated Vulnerability Disclosure** principles.